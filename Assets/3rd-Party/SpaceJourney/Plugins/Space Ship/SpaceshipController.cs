...
public class SpaceshipController : MonoBehaviour
{
	...
	private void Awake()
	{
		...
		m_cachedCameraTransform = m_camera.PrimaryCamera.transform;
		m_idleCameraDistance = CameraOffsetVector.magnitude;
		m_initialAvatarRotation = m_spaceship.Avatar.localRotation;
		m_initialCameraFOV = m_camera.PrimaryCamera.fieldOfView;
	...
	private void UpdateCamera()
	{
		...
		m_camera.PrimaryCamera.fieldOfView = 2.0f * Mathf.Atan(baseFrustumHeight * 0.5f / Vector3.Distance(
	...
	private struct CameraSettings
	{
		...
		[Tooltip("Primary camera object.")] public Camera PrimaryCamera;
    }
